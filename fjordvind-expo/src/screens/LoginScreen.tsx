...
export default function LoginScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (isSignUp && !name) {
      showAlert('Feil', 'Vennligst oppgi navn');
      return;
    }
    ...
    try {
      if (isSignUp) {
        ...
        showAlert('Suksess', 'Konto opprettet!');
      } else {
        await signIn(email, password);
      }
    } catch (error: any) {
      showAlert('Feil', error.message || 'Noe gikk galt');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>FjordVind</Text>
      </View>
