/**
 * PDF Generator Service for FjordVind Lusevokteren
 *
...
async function generateMattilsynetReport(options) {
  ...
  doc.text(
    'Denne rapporten er generert av FjordVind Lusevokteren og oppfyller kravene i forskrift om lakselusbekjempelse (FOR-2012-12-05-1140).',
...
async function generateTreatmentReport(options) {
  ...
  doc.fontSize(12)
     .fillColor(COLORS.text)
     .text('FjordVind Lusevokteren', { align: 'center' });
